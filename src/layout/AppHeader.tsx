  ...
  useEffect(() => {
    const fetchSupportLink = async () => {
      try {
        ...
        if (docSnap.exists()) {
          setSupportLink(docSnap.data().supportTicketLink || "");
        }
      } catch (error) {
          ...
          <div className="flex items-center gap-2 2xsm:gap-3">
            ...
            {supportLink && (
              <a
                ...
                className="flex items-center justify-center w-10 h-10 text-gray-500 border border-gray-200 rounded-lg hover:text-primary dark:border-gray-800 dark:text-gray-400 dark:hover:text-white"
