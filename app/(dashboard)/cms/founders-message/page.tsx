...
const DEFAULT_DATA: FoundersMessageData = {
    ...
    body: `As I pause to reflect on the journey of Kind Minds Family Wellness (KMFW), I am filled with profound gratitude and a deep sense of purpose...`,
...
export default function FoundersMessageManager() {
    ...
    const loadData = async () => {
        ...
        try {
            ...
            if (doc) setData({ ...DEFAULT_DATA, ...doc });
        } catch (e) {
