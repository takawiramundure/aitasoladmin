...
const DEFAULT_DATA = {
    ...
    form_fields: [
        ...
        { id: 'message', label: 'Message / Care Needs', type: 'textarea', required: true }
    ]
};

export default function AppointmentFormManager() {
    ...
    const loadContent = async () => {
        ...
        try {
            ...
            const data = await FirestoreService.getPageContent('appointment_form', currentSite.id);
    ...
    const handleSave = async () => {
        ...
        try {
            await FirestoreService.savePageContent('appointment_form', content, currentSite.id);
    ...
    return (
        <>
            <PageMeta title="Appointment Form Manager | Admin Portal" description="Manage the global appointment form" />
            
            <div className="p-6 max-w-4xl space-y-6">
                <div className="flex items-center justify-between mb-2">
                    <div>
                        <h2 className="text-2xl font-bold text-gray-800 dark:text-white">Global Appointment Form Manager</h2>
